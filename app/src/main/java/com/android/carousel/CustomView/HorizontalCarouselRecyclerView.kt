package com.android.carousel.CustomView
...
class HorizontalCarouselRecyclerView(
    ...
    private val activeColor by lazy { ContextCompat.getColor(context, R.color.white) }
    private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.white) }
